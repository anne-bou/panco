...
from panco.fifoCplex.plpConstraintsTree import PLPConstraintsTreeCpx
from panco.fifoCplex.elpConstraintsTree import ELPConstraintsTreeCpx
from panco.fifoCplex.sfaLP import SfaLPCpx
from panco.fifoCplex.admTFA import AdmTfaCpx
from panco.fifoCplex.cplex_lex import  extract_obj, cplex_solve
...
class TreeOnlyLPCpx:
    ...
    def __init__(self, network, foi, polynomial=True, sfa=True, tfa=True, filename="fifo.lp"):
        ...
        if tfa:
            ...
            delay_tfa = None
        if polynomial:
            self.constraints = PLPConstraintsTreeCpx(network, foi, delay_sfa, delay_tfa)
        else:
            self.constraints = ELPConstraintsTreeCpx(network, foi)
