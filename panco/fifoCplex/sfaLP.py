...
from panco.fifoCplex.cplex_lex import cplex_solve, lex_cplex, sol_extraction, extract_obj, sol_extraction_burst


class SfaLPCpx:
    def __init__(self, network: Network, filename="sfacplex.lp"):
        """
    ...
    def ff_equiv(self) -> Network:
        ...
        file.write('maximize \n obj: ')
        file.write('x0')
        for f in range(1, self.forest.num_flows):
        ...
        self.forest = sol_extraction_burst(dict_sol, self.forest)
        # print(self.forest)
        return (self.forest)
